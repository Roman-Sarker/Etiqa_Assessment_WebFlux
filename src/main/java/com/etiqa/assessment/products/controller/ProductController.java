package com.etiqa.assessment.products.controller;
...
import com.etiqa.assessment.products.service.ProductService;
...
@Tag(
        ...
        description = "This API allows to add new book, update book, delete book, and retrieve book by id/all."
)
@RestController
